function C = clustSm(A,K)
% CLUSTSM give K-medois clustering for the points on S^m
% 
...
%                  
% input A: (m+1) x n matrix, whose column is an element of S^m
...
if nargin == 1;
   % then proceed to find number of K
    ...
    D = real(acos(A'*A)) ; % n x n distance matrix
