function gm = medianSm(vdata,Error)
% medianSm  geometric meadian of data on S^m (Sphere) 
%               using Fletcher et al. (2009) method. 
% 
% gm = medianSm(vdata)
% gm = medianSm(vdata,Error)
%
% Inputs:   vdata   - a matrix (m+1)-by-n : a column vector represents a point on S^m  
%           Error   - a scalar for optimization 
%                 
% Output:
%           gm    - geometric median on S^m
% 
% Note: 
