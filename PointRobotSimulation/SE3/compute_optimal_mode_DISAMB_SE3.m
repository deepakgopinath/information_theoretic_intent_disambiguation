function [ best_mode ] = compute_optimal_mode_DISAMB_SE3( intent_type, xr_T, pg )
...
for i=1:nd
    ...
    Dk(i) = compute_disamb_heuristic_SE3(uh_p, intent_type, xr_T, pg) + compute_disamb_heuristic_SE3(uh_n, intent_type, xr_T, pg); 
end
