function [ best_mode ] = compute_optimal_mode_DISAMB_SE2( intent_type, curr_x, pg )
...
for i=1:nd
    ...
    Dk(i) = compute_disamb_heuristic_SE2(uh_p, intent_type, curr_x, pg) + compute_disamb_heuristic_SE2(uh_n, intent_type, curr_x, pg); 
end
