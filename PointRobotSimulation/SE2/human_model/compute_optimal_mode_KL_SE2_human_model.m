function [ best_mode ] = compute_optimal_mode_KL_SE2_human_model( intent_type, xr_T, pg )
...
for i=1:length(cm)
    ...
    for j=1:ng
        ...
        for k=1:num_samples
            curr_goal = xg(:, j);
            projected_kl(k) = compute_projected_kl_SE2_human_model(curr_mode, curr_goal, intent_type, xr_T, pg);
        end
